...
import { FaChevronDown, FaChevronLeft, FaChevronRight, FaStar } from 'react-icons/fa6'
...
export default function AdminHome() {
	...
	useEffect(() => {
		...
		dispatch(getProductsByFiltersAsync({ filter, sort, pagination, admin: true }))
							...
							<div className="lg:col-span-3">
								<div>
									<Link
										...
										className="rounded-md mx-10 my-5 bg-green-700 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
									>
										Add New Product
									</Link>
								</div>
									...
									{section.options.map((option, optionIdx) => (
										<div key={option.value} className="flex items-center">
											<input
												...
												className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-prbg-primary/90"
											/>
											<label
			...
			<div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
				...
				<div>
					...
					>
						...
						{/* Current: "z-10 bg-primary/90 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary", Default: "text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-offset-0" */}
						...
						{Array.from({ length: totalPages }).map((el, index) => (
							<div
								...
								className={`relative cursor-pointer z-10 inline-flex items-center ${
									index + 1 === page ? 'bg-primary/90 text-white' : 'text-gray-400'
						...
						<div key={product.id}>
							...
							<div className="mt-5">
								<Link
									...
									className="rounded-md bg-primary/90 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
								>
									Edit Product
								</Link>
							</div>
